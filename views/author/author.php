        ...
        <div class="row">
            <div class="col-sm">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        // Kết nối và lấy dữ liệu từ mô hình
                        ...
                        foreach ($authors as $author) {
                            echo "<tr>";
                            echo "<td>{$author['ma_tgia']}</td>";
                            echo "<td>{$author['ten_tgia']}</td>";
                            echo "<td><img src='{$author['hinh_tgia']}' alt='Image' style='width: 50px; height: 50px;'></td>";
                            echo "<td class='text-center'><a href='edit_author.php?id={$author['ma_tgia']}' class='btn btn-warning'>Sửa</a></td>";
