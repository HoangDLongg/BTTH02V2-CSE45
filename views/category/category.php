                    ...
                    <tbody>
                        ...
                        if (!empty($categories)) {
                            foreach ($categories as $category) {
                                echo "<tr>";
                                echo "<td>" . htmlspecialchars($category['ma_tloai']) . "</td>";
                                echo "<td>" . htmlspecialchars($category['ten_tloai']) . "</td>";
                                echo "<td><a href='edit_category.php?id=" . htmlspecialchars($category['ma_tloai']) . "'><i class='fa-solid fa-pen-to-square' alt='Sửa'></i></a></td>";
                                echo "<td><a href='category.php?action=delete&id=" . htmlspecialchars($category['ma_tloai']) . "'><i class='fa-solid fa-trash-can' alt='Xóa'></i></a></td>";
                                echo "</tr>";
                            }
                        } else {
