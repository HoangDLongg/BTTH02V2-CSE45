...
<body>
    ...
    if (isset($_GET['id'])) {
        ...
        $category = $categoryController->indexId($ma_tloai); // Gọi đúng phương thức
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!empty($ma_tloai) && !empty($ten_tloai)) {
            $categoryController->update($ma_tloai,$ten_tloai);
    ...
    <main class="container mt-5 mb-5">
        ...
        <div class="row">
            <div class="col-sm">
                <h3 class="text-center text-uppercase fw-bold">Sửa / Update</h3>
                <form action="edit_category.php" method="post">
                <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Mã thể loại</span>
                        <input type="text" class="form-control" name="ma_tloai" value = "<?php echo $ma_tloai ?>" readonly>
                    </div>
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Tên thể loại</span>
                        <input type="text" class="form-control" name="ten_tloai" value="<?php echo htmlspecialchars($category['ten_tloai']); ?>">
                    </div>

                    <div class="form-group  float-end ">
                        <input type="submit" value="Edit/Sửa" class="btn btn-success">
